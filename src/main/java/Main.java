...
public class Main {
    public static void main(String[] args) {
        String rainDataStr = Rainfall.getRainDataForTown("Lima", "Rome:Jan 90.2,Feb 73.2,Mar 80.3,Apr 55.7,May 53.0,Jun 36.4,Jul 17.5,Aug 27.5,Sep 60.9,Oct 147.7,Nov 121.0,Dec 97.9\n" +
        ...
        System.out.println(rainDataStr);
        ArrayList<Float> rainData = Rainfall.getRainData(rainDataStr);
        rainData.stream().forEach(i -> System.out.println(i));
    }
}
